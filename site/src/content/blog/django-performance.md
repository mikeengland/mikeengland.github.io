...
description: 'Five practical techniques for finding N+1 queries and slow SQL generated by the Django ORM, from query logging and test assertions to EXPLAIN plans.'
pubDate: 'Jan 12 2020'
---
...
If you would like more flexibility, for example to assert that the number of queries is between 1 and 10, or less than 5, [Luke Plant wrote a blog post](https://lukeplant.me.uk/blog/posts/fuzzy-testing-with-assertnumqueries/) on how to achieve this with assertNumQueries.
